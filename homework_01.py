...
print(f"Всього {total_trees} дерев в саду")
...
print(f"Вечірня температура повітря складає {evening_temperature} градус")
...
today_boys = boys - 1
today_girls = girls - 2
total_kids = today_boys + today_girls
print(f"Всього до театрального гуртку прийшло {total_kids} дитини")
...
print(f"Загальна кількість книжок складає {total_cost_books} одиниць")
