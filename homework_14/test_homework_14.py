...
class TestSiteUser(unittest.TestCase):
    def setUp(self):
        self.user1 = homework_14.SiteUser("Oleg Petrov", "oleg.petrov@test.com", "user")
        self.user2 = homework_14.SiteUser("Ira Bila", "ira.bila@test.com", "admin")
        self.user3 = homework_14.SiteUser("Inna Tyma", "inna.tyma@test.com", "moderator")
    ...
    def test_invalid_access_level(self):
        with self.assertRaises(homework_14.AccessLevelException):
